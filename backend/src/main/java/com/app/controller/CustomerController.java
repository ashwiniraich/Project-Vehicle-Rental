...
public class CustomerController {
	...
	@PostMapping("/{customerId}/categories/{vehicleId}")
    public ResponseEntity<Booking> addCustomerBooking(@PathVariable Long customerId, @PathVariable Long vehicleId) {
        custService.addBooking(customerId, vehicleId);
